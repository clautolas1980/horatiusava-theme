...
<body <?php body_class( 'image_background_header' ); ?>>
<?php wp_body_open(); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-4 header_logo" >
                            <a class="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">                  
                                <img class="logo_black" src="<?php echo get_template_directory_uri() . '/corandus/images/HS_Logo_black.svg' ?>" alt="Horatiu Sava">
                                <img class="logo_white" src="<?php echo get_template_directory_uri() . '/corandus/images/HS_Logo_white.svg' ?>" alt="Horatiu Sava">
                            </a>  
                        </div>
