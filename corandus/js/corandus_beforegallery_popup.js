...
$( document ).ready(function( $ ) { 
    ...
    $( "#mobile_menu_btn" ).click( function() {
        ...
        $( ".image_background_header .site-header" ).toggleClass( 'opened' );
        $( "#desktop_menu_icon" ).toggleClass( 'opened' );
...
function doubleclickHoverMobile() {
    $('.social_column a, .social_column_background_image a').attr('first-clicked','0');
    $('.social_column a, .social_column_background_image a').on('click', function(e) {
        if(isMobile() && $(this).attr('first-clicked')== '0') {
            $('.social_column a, .social_column_background_image a').attr('first-clicked','0');
            e.preventDefault();
            $(this).attr('first-clicked','1');
                ...
                $.each( data.photos.photo, function ( num, photo ) {
                    ...
                    var flickrHtml = 
                        '<div class="social_column">'+ 
                            '<a href="' + photo_url + '">' +
                                '<img src="'+photo_src+'" alt="' + photo_title + '" />'+
